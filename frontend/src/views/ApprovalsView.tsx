...
import { approveTask, downloadOutputFile, fetchTasks, rejectTask } from '../lib/api'
            ...
            {pendingTasks.map((task) => (
              ...
              >
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2">
                    <span className="rounded bg-warning/10 border border-warning/30 px-2 py-0.5 font-mono text-[10px] uppercase tracking-wider text-warning">
                      Pending Review
                    </span>
                  ...
                  {task.generatedFile && (
                    <div className="flex items-center gap-2 text-xs text-signal">
                      ...
                      <button
                        type="button"
                        onClick={() => downloadOutputFile(task.generatedFile!)}
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-signal/50 bg-signal/10 px-3 py-1.5 text-xs font-medium text-signal hover:bg-signal/20 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-danger/50 bg-danger/10 px-3 py-1.5 text-xs font-medium text-danger hover:bg-danger/20 transition-colors"
                  >
